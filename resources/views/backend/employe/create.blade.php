                   ...
                   <form action="{{ route('employe.store') }}" method="post" >
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-8 mb-3">
                                    ...
                                    <input type="number" name="salaire" value="{{ old('salaire') }}" class="form-control">
                               </div>
                            ...
                            <div class="col-6 mb-3">         
                               ...
                               <select name="situation_soc" id="situation_soc" class="form-control">
                                   <option value="1" {{ old('situation_soc') == '1' ? 'selected' : null }}>Célibataire</option>
                                   <option value="2" {{ old('situation_soc') == '2' ? 'selected' : null }}>Marié</option>
                                   <option value="3" {{ old('situation_soc') == '3' ? 'selected' : null }}>Divorcé</option>
                                 </select>
                             ...
                             <div class="col-12 mb-3">         
                                ...
                                <select name="service_id" id="service" class="form-control">
                                         ...
                                         <option value="{{ $service->id }}" {{ old('service') == $service->id ? 'selected' : null }}>{{ $service->name }}</option>
                                     @endforeach
                                  </select>
                             </div>
                                 ...
                                 <div class="col-12 mb-3">         
                                    ...
                                    <select name="fonction_id" id="fonction" class="form-control">
                                        @foreach($fonctions as $fonction)
                                         <option value="{{ $fonction->id }}" {{ old('fonction') == $fonction->id ? 'selected' : null }}>{{ $fonction->name }}</option>
                                        @endforeach
                                     </select>
                                </div>
